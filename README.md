...
- Local Jarvis webhook receiver registers with the daemon so call-ended and action-items-ready events refresh the Live Call surface without waiting for manual refresh/reopen.
